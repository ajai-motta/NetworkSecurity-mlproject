...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TraingPipelineConfig):
        self.model_trainer_dir: str=os.path.join(training_pipeline_config.artifact_dir,trainig_pipeline.MODEL_TRAINER_DIR)
        self.trained_model_file_name: str=os.path.join(self.model_trainer_dir,trainig_pipeline.MODEL_TRAINER_TRAINED_DIR,trainig_pipeline.MODEL_FILE_NAME)
        self.model_trainer_expected_score=trainig_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.model_overfitting_threshold=trainig_pipeline.MODEL_OVERFITTING_THESHOLD